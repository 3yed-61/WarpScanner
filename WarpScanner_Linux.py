        ...
        if do_you_save=='1':
        	...
        	if which =='4':
        	 ...
        	 '2' : 'vahid panel(with enter)'})
        		with open('/tmp/result.csv', 'r') as f:
        		    b=f.readlines()
        		    with open('/tmp/clean_result.csv', 'w') as ff:
        		        for j in b:
        		             	if which =='1':
        		...
        		print(' saved in /tmp/clean_result.csv !')
        		exit()
